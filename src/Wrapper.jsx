...
const Wrapper = (props) => {
  ...
  return (
      <todoWrapper.Provider value={{selected_note,set_selected_note,notes,setNotes,category,setCategory,popUp,setPopUp,note_popup,setNote_popup,add_data_pop , set_add_data_pop}}>
          { props.children }
